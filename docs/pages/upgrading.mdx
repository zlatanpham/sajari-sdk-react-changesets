...
<SEO title="Upgrading" description="How to upgrade from version 2 of Sajari's React SDK to version 3." />

# Upgrading

The previous version of the React SDK ([`@tpham0/sdk-react`](https://www.npmjs.com/package/@tpham0/sdk-react])) was a single package. The latest version is split into three packages.

If you still want to use the pre-built components, you'll want to use the [`@tpham0/search-ui`](https://www.npmjs.com/package/@tpham0/search-ui]) package, which has the following differences from v2 of the React SDK:
