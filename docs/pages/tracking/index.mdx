...
- `NoTracking`: self-explantory, this is also the default when you create a new `Pipeline` instance
...
```js
import { ClickTracking, PosNegTracking, Pipeline } from '@tpham0/react-hooks';
...
- [`NoTracking`](/tracking/notracking)
