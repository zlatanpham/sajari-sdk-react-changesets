...
```js
import { ClickTracking } from '@tpham0/react-hooks';
// or...
import { ClickTracking } from '@tpham0/react-search-ui';
```
...
More details about `ClickTracking` can be found [here](https://www.sajari.com/docs/user-guide/analytics/click-tracking/).
