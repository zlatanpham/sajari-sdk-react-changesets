...
<div className="flex space-x-2">
  <img src="https://badgen.net/bundlephobia/minzip/@tpham0/react-hooks?cache=300" alt="Size" />
  <img src="https://badgen.net/npm/v/@tpham0/react-hooks?cache=300" alt="Latest NPM version" />
</div>
...
```js
import { Pipeline, SearchProvider, useSearch } from '@tpham0/react-hooks';
```

In this basic example, we'll also use components from the `@tpham0/react-components` package:
