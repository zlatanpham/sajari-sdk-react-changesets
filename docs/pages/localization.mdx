...
We use [i18next](https://react.i18next.com/) to handle localization of various parts of our `@tpham0/react-search-ui` interfaces. We export our instance of i18next so that it is possible to provide your own localizations for your search interfaces.
...
```js
import { i18n } from '@tpham0/react-search-ui';
```
