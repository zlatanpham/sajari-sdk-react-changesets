...
The `PoweredBy` component is used to display that you're awesome and Sajari powering your search UI 💪. If you're on a starter plan, it is required to display this component where Sajari search logic is used.

```js
import { PoweredBy } from '@tpham0/react-search-ui';
```
