...
<SEO title="Tabs" scope={scopes.components} description="An accessible Tabs component for your application." />
...
```js
import { Tabs, TabList, TabPanels, Tab, TabPanel } from '@tpham0/react-components';
```
