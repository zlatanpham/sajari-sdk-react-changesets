...
```js
import { Pipeline } from '@tpham0/react-hooks';
// or
import { Pipeline } from '@tpham0/react-search-ui';
```
...
```js
import { EVENT_RESPONSE_UPDATED } from '@tpham0/react-hooks';
// or
import { EVENT_RESPONSE_UPDATED } from '@tpham0/react-search-ui';
