...
This document outlines how to control the styling of the the React components in the `@tpham0/react-search-ui` package.
...
Or if you want complete control of rendering and styling, you should use the `@tpham0/react-hooks` package with your own components.
